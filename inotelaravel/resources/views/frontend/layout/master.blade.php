                ...
                <nav class="pcoded-navbar">
                    <div class="nav-list">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div><img style="margin-left: 60px; width: 100px" class="img-radius " src="{{\Illuminate\Support\Facades\Auth::user()->avatar ?? 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqchnDJ6zreYOFN7Sag4iGQPEhjseY59SfQ-mf9bN2GpE8fcPXGGO3QC0YLVId0xw2zFU&usqp=CAU'}}"></div>
                            <div><p class="pcoded-navigation-label">Name : {{\Illuminate\Support\Facades\Auth::user()->name ?? " "}}</p></div>
                            <div><a href="{{route("login.form")}}" class="btn btn-danger">Logout</a></div>
...
{{--                                        <span class="pcoded-mtext">Note</span>--}}
{{--                                    </a>--}}
